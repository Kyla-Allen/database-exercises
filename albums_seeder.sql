...
('Various', 'Grease: The Original Soundtrack', 1978, 14.4, 'Rock and roll'),
...
('Abba', 'Gold: Greatest Hists', 1992, 22.7, 'Pop'),
('Madonna', 'THe Immaculate Collection', 1990, 19.4, 'Pop'),
('The Beatles', 'Abbey Road', 1969, 14.4, 'Rock'),
('Bruse Springsteen', 'Born in the USA', 1984, 19.6, 'Heartland Rock'),
('Die Straits', 'Brothers in Arms', 1985, 17.7, 'Roots Rock'),
